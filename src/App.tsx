...
export function App() {
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col bg-gray-50 dark:bg-dark-bg text-gray-900 dark:text-gray-100 transition-colors duration-200">
      ...
      <footer className="py-4 px-6 bg-white dark:bg-dark-card/80 border-t border-gray-200 dark:border-dark-border text-center text-xs text-gray-500 dark:text-gray-400">
        <p>
          <strong>Projeto MIDAS</strong> &bull; Sistema Profissional de Planejamento Financeiro & Patrimônio
        </p>
